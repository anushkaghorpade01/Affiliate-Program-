          ...
          <h2 className="text-[#E8F5F0]">
            <span className="flex flex-col items-center gap-1.5 font-sans text-[calc(0.875rem+1.5px)] font-normal leading-[calc(1.38em-4.25px)] tracking-[0.01em] text-[#E8F5F0]">
              <a
                ...
                className="relative z-[2] block cursor-pointer rounded-sm text-[#E8F5F0] underline decoration-[rgba(232,245,240,0.28)] decoration-1 underline-offset-[0.32em] outline-none transition-[color,text-decoration-color] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:text-[rgba(252,249,244,0.95)] hover:decoration-[rgba(252,249,244,0.55)] focus-visible:ring-1 focus-visible:ring-[#f4f1ea]/25 active:text-[rgba(252,249,244,0.88)] active:decoration-[rgba(252,249,244,0.42)]"
              >
                Apply Now.
              </a>
